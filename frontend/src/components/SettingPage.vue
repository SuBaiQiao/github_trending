<template>
  <div class="setting-page">
    <!-- 选择框 -->
    <div>
      <a-segmented v-model:value="selectedPeriod" :options="periodOptions" style="margin-right: 16px;"></a-segmented>
    </div>
    <!-- 按钮 -->
    <div>
      <a-button @click="fetchDataByPeriod" :loadding="loadding">获取数据</a-button>
    </div>
  </div>
</template>
